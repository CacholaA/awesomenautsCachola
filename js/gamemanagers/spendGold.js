   ...
   setBuyText: function(){
        game.data.buytext = new (me.Renderable.extend({
                    ...
                    draw: function(render){
                        ...
                        this.font.draw(render.getContext(), "Skill 2: Run x4! Current Level: " + game.data.skill2 + " Cost: " + ((game.data.skill2+1)*10),this.pos.x, this.pos.y + 80);
                        ...
                        this.font.draw(render.getContext(), "Q Ability: Speedboost| Current Level: " + game.data.ability1 + " Cost: " + ((game.data.ability1+1)*10), this.pos.x, this.pos.y + 160);
                        this.font.draw(render.getContext(), "W Ability: Eat creep: " + game.data.ability2 + " Cost: " + ((game.data.ability2+1)*10), this.pos.x, this.pos.y + 200);
